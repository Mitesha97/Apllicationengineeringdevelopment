...
public class ManageUserAccount extends javax.swing.JPanel {
    ...
    private void populateRoleComboBox(Enterprise e){
       ...
       // for (Role role : e.getSupportedRole()){
            roleComboBox.addItem(new ChangeMakerRole());
    ...
    private void initComponents() {
        ...
        userTable.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
...
if(usernameTxt.getText().isEmpty()|| passwordTxt.getText().isEmpty()){
        ...
        if (organization instanceof ChangeMakerOrganization){
           ...
           ((ChangeMakerOrganization) organization).getChangemakerlist().getChangeMakerDirectory().add(cm);
